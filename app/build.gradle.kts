...
android {
    namespace = "com.soc.optionchain"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.soc.optionchain"
        minSdk = 29
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation("androidx.compose.material3:material3") // Material 3 (Monet)
    
    // Navigation Compose
    implementation("androidx.navigation:navigation-compose:2.7.7")
    
    // Networking: OkHttp for WebSocket and HTTP API
    implementation("com.squareup.okhttp3:okhttp:4.12.0")
    
    // JSON Parsing: Gson (or Moshi/Kotlinx Serialization)
